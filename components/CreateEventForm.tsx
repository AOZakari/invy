...
const FREE_THEMES = THEME_OPTIONS.slice(0, 2);

export default function CreateEventForm({ hasCustomSlugAccess, hasAdvancedThemes }: CreateEventFormProps) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (hasCustomSlugAccess && slug?.trim()) data.slug = slug.trim().toLowerCase();
          ...
          <div className="space-y-3 pt-4 border-t border-gray-200 dark:border-gray-800">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
              >
                {(hasAdvancedThemes ? THEME_OPTIONS : FREE_THEMES).map((t) => (
            ...
            {hasCustomSlugAccess ? (
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  invy.rsvp/e/<span className="font-mono">your-slug</span>
                </p>
              </div>
            ) : (
              <div>
                <label className="block text-sm font-medium mb-1">Custom URL</label>
                <div className="px-3 py-2 text-sm text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800/50">
